        ...
        <>
            <nav className="flex flex-wrap items-center justify-between p-5 bg-white select-none">
                <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
                    <FontAwesomeIcon icon={faLemon} className="text-shadow text-yellow-400" style={{ color: "yellow", width: "3rem", height: "3rem", marginInlineEnd: "0.6rem" }} />
                    <span className="font-semibold text-xl text-black tracking-tight">Little Lemon</span>
                </a>

                <div className="block lg:mt-0 text-black -mt-4">
